import { FaPython, FaHtml5, FaCss3Alt, FaJs, FaReact, FaFigma, FaGithub, FaNodeJs, FaRobot } from 'react-icons/fa';
import { SiTailwindcss, SiNextdotjs, SiTypescript, SiMongodb, SiEthereum } from 'react-icons/si';
...
export const AboutIcons = {
  ...
  tailwind: <SiTailwindcss className="text-foreground" title="Tailwind CSS" size={24} />,
  figma: <FaFigma className="text-foreground" title="Figma" size={24} />,
  yolov8: <FaRobot className="text-foreground" title="AI / Object Detection" size={24} />,
